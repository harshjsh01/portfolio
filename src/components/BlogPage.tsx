...
const BlogPage = () => {
  ...
  if (selectedBlog) {
    return (
      <div style={{ position: 'relative', overflow: 'hidden', minHeight: '100vh', backgroundColor: '#030305' }}>
        <BackgroundBlobs />
        <div style={{ padding: '5rem 2rem', color: 'white', maxWidth: '800px', margin: '0 auto', fontFamily: 'sans-serif', position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ lineHeight: '1.8', fontSize: '1.2rem', whiteSpace: 'pre-wrap', paddingBottom: '3rem' }}>
  ...
  return (
    <div style={{ position: 'relative', overflow: 'hidden', minHeight: '100vh', backgroundColor: '#030305' }}>
      <BackgroundBlobs />
      <div style={{ padding: '5rem 2rem', color: 'white', maxWidth: '1000px', margin: '0 auto', fontFamily: 'sans-serif', position: 'relative', zIndex: 10, minHeight: '80vh' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '2rem' }}>
          {blogs.map(blog => (
            <div key={blog.id} onClick={() => setSelectedBlog(blog)} style={{ cursor: 'pointer', border: '1px solid rgba(255,255,255,0.2)', borderRadius: '8px', overflow: 'hidden', transition: 'transform 0.2s', background: 'rgba(255,255,255,0.02)', backdropFilter: 'blur(10px)' }} onMouseOver={e => e.currentTarget.style.transform = 'translateY(-5px)'} onMouseOut={e => e.currentTarget.style.transform = 'none'}>
